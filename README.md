...
Cape is an experimental project, should be used for research and educational purposes and should not be applied in production. If you agree on the statement "Don't roll your own crypto" you should not use Cape for the following 2 reasons:
